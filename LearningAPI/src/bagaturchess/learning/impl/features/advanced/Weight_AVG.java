...
class Weight_AVG implements Serializable {
	...
	public Weight_AVG(double min, double max, double _initialVal, boolean _norm_adjustment) {
		
		this(min, max, _initialVal);
	}
	
	
	public Weight_AVG(double min, double max, double _initialVal) {
	...
	protected void merge(Weight_AVG other) {
