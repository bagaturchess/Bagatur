...
public class SF7_FeaturesConfigurationBagaturImpl implements IFeaturesConfiguration, IFeatureComplexity, SF7_FeaturesConstants {
	...
	public IFeature[] getDefinedFeatures() {
		...
		add(new_featuresSet, new AdjustableFeatureSingle(FEATURE_ID_UNSTOPPABLE_PASSER  , "PAWNS.UNSTOPPABLE.PASSER" , PAWNS_STRUCTURE ,   0, 0,  0,   0, 700,  550 ));
		...
		add(new_featuresSet, new AdjustableFeatureSingle(FEATURE_ID_KING_PASSERS_F  	, "KINGS.PASSERS.F"     , PAWNS_STRUCTURE ,   0,   0, 0, 0, 20, 1 ));
		add(new_featuresSet, new AdjustableFeatureSingle(FEATURE_ID_KING_PASSERS_FF  	, "KINGS.PASSERS.FF"    , PAWNS_STRUCTURE ,   0,   0, 0, 0, 20, 1 ));
		add(new_featuresSet, new AdjustableFeatureSingle(FEATURE_ID_KING_PASSERS_F_OP   , "KINGS.PASSERS.F.OP"  , PAWNS_STRUCTURE ,   0,   0, 0, 0, 20, 1 ));
		add(new_featuresSet, new AdjustableFeatureSingle(FEATURE_ID_PAWNS_ISLANTS       , "PAWNS.ISLANDS"       , PAWNS_STRUCTURE , -50,  50, -0.447, -50,  50, -0.84 ));
