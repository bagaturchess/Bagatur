...
export JARS_PATH="${BIN_PATH}egtbprobe.jar:${BIN_PATH}BagaturBoard.jar:${BIN_PATH}BagaturOpening.jar:${BIN_PATH}BagaturSearch.jar:${BIN_PATH}BagaturUCI.jar:${BIN_PATH}BagaturEngines.jar:${BIN_PATH}BagaturLearningAPI.jar:${BIN_PATH}BagaturEGTB.jar:${BIN_PATH}BagaturLearningImpl.jar:"
