...
public class BagaturEvaluator_lazyeval_experiments extends EvaluatorAdapter implements FeatureWeights {
	...
	private static VarStatistic varstat_INT1;
	private static VarStatistic varstat_INT2;
	private static VarStatistic varstat_INT3;
	private static VarStatistic varstat_INT4;
	...
	BagaturEvaluator_lazyeval_experiments(IBitBoard _bitboard, IEvalCache _evalCache, IEvalConfig _evalConfig) {
	...
	public void beforeSearch() {
		...
		varstat_INT1 = new VarStatistic(false);
		varstat_INT2 = new VarStatistic(false);
		varstat_INT3 = new VarStatistic(false);
		varstat_INT4 = new VarStatistic(false);
	}
	...
	public int lazyEval(int depth, int alpha, int beta, int rootColour) {
		...
		//INT1 = varstat_INT1.getEntropy() + 3 * varstat_INT1.getDisperse();
		int eval_test = returnVal(eval);
		...
		//INT2 = varstat_INT2.getEntropy() + 3 * varstat_INT2.getDisperse();
		eval_test = returnVal(eval);
		...
		//INT3 = varstat_INT3.getEntropy() + 3 * varstat_INT3.getDisperse();
		eval_test = returnVal(eval);
		...
		//INT4 = varstat_INT4.getEntropy() + 3 * varstat_INT4.getDisperse();
		eval_test = returnVal(eval);
		...
		varstat_INT1.addValue(int1, int1);
		varstat_INT2.addValue(int2, int2);
		varstat_INT3.addValue(int3, int3);
		varstat_INT4.addValue(int4, int4);
