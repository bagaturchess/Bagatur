...
public class Position implements IPosition {
    ...
    // Bitboards
    private long[] pieceTypeBB;
    private long whiteBB, blackBB;
    
    // Piece square table scores
    private short[] psScore1, psScore2;

    private boolean whiteMove;

    /** Bit definitions for the castleMask bit mask. */
    private static final int A1_CASTLE = 0; /** White long castle. */
    private static final int H1_CASTLE = 1; /** White short castle. */
    private static final int A8_CASTLE = 2; /** Black long castle. */
    private static final int H8_CASTLE = 3; /** Black short castle. */
    ...
    private int wMtrl;      // Total value of all white pieces and pawns
    private int bMtrl;      // Total value of all black pieces and pawns
    private int wMtrlPawns; // Total value of all white pawns
    private int bMtrlPawns; // Total value of all black pawns
    ...
    public Position() {
        ...
        wKingSq = bKingSq = -1;
        setwMtrl(setbMtrl(-Evaluate.kV));
        setwMtrlPawns(setbMtrlPawns(0));
    }
    ...
    public Position(Position other) {
        ...
        setWhiteMove(other.isWhiteMove());
        ...
        setwMtrl(other.getwMtrl());
        setbMtrl(other.getbMtrl());
        setwMtrlPawns(other.getwMtrlPawns());
        setbMtrlPawns(other.getbMtrlPawns());
    }
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getPieceTypeBB(int)
	 */
    @Override
	public long getPieceTypeBB(int pid) {
    	return pieceTypeBB[pid];
    }
    
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getWhiteBB()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getBlackBB()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getPIDBySquare(int)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getWKingSQ()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getBKingSQ()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getPST1(int)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getPST2(int)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#pawnZobristHash()
	 */
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#kingZobristHash()
	 */
    @Override
    ...
    final public boolean drawRuleEquals(Position other) {
        ...
        if (isWhiteMove() != other.isWhiteMove())
            return false;
    ...
    public final int getX(int square) {
        return BitBoard.getX(square);
    }
    /** Return y position (rank) corresponding to a square. */
    public final int getY(int square) {
        return BitBoard.getY(square);
    }
    ...
    public final void setPiece(int square, int piece) {
        ...
        if (removedPiece != Piece.EMPTY) {
            ...
            if (Piece.isWhite(removedPiece)) {
                setwMtrl(getwMtrl() - pVal);
                whiteBB &= ~sqMask;
                if (removedPiece == Piece.WPAWN) {
                    setwMtrlPawns(getwMtrlPawns() - pVal);
                    pHashKey ^= psHashKeys[Piece.WPAWN][square];
                }
            } else {
                setbMtrl(getbMtrl() - pVal);
                blackBB &= ~sqMask;
                if (removedPiece == Piece.BPAWN) {
                    setbMtrlPawns(getbMtrlPawns() - pVal);
    ...
    /* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getKingSq(boolean)
	 */
    @Override
    ...
    /*COMMENTED public final void makeMove(Move move, UndoInfo ui) {
    ...
    /*COMMENTED public final void unMakeMove(Move move, UndoInfo ui) {
        hashKey ^= whiteHashKey;
        whiteMove = !whiteMove;
     ...
     * Special version that only updates enough of the state for the SEE function to be happy.
     */
    /*COMMENTED public final void makeSEEMove(Move move, UndoInfo ui) {
        ui.capturedPiece = squares[move.to];
        boolean wtm = whiteMove;
    ...
    /*COMMENTED public final void unMakeSEEMove(Move move, UndoInfo ui) {
        whiteMove = !whiteMove;
        int p = squares[move.to];
	...
	public void setwMtrl(int wMtrl) {
		this.wMtrl = wMtrl;
	}

	/* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getwMtrl()
	 */
	@Override
	public int getwMtrl() {
		return wMtrl;
	...
	public int setbMtrl(int bMtrl) {
		this.bMtrl = bMtrl;
		return bMtrl;
	}

	/* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getbMtrl()
	 */
	@Override
	public int getbMtrl() {
		return bMtrl;
	...
	public void setwMtrlPawns(int wMtrlPawns) {
		this.wMtrlPawns = wMtrlPawns;
	}

	/* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getwMtrlPawns()
	 */
	@Override
	...
	public int setbMtrlPawns(int bMtrlPawns) {
		this.bMtrlPawns = bMtrlPawns;
		return bMtrlPawns;
	}

	/* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#getbMtrlPawns()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bagaturchess.engines.bagatur.v14.IPosition#isWhiteMove()
	 */
	@Override
    ...
    /*COMMENTED public final String toString() {
