...
public class BagaturV12Evaluator extends BaseEvaluator {
    ...
    public BagaturV12Evaluator(IBitBoard _bitboard, IEvalCache _evalCache, IWeightsEvalConfig _evalConfig) {
