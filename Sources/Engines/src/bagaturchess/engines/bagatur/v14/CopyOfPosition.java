...
public class CopyOfPosition {
    ...
    public CopyOfPosition(CopyOfPosition other) {
        squares = new int[64];
        for (int i = 0; i < 64; i++)
    ...
    public boolean equals(Object o) {
        if ((o == null) || (o.getClass() != this.getClass()))
            return false;
        CopyOfPosition other = (CopyOfPosition)o;
     ...
     */
    final public boolean drawRuleEquals(CopyOfPosition other) {
        for (int i = 0; i < 64; i++) {
    ...
    private final void removeCastleRights(int square) {
        if (square == CopyOfPosition.getSquare(0, 0)) {
            setCastleMask(castleMask & ~(1 << CopyOfPosition.A1_CASTLE));
        } else if (square == CopyOfPosition.getSquare(7, 0)) {
            setCastleMask(castleMask & ~(1 << CopyOfPosition.H1_CASTLE));
        } else if (square == CopyOfPosition.getSquare(0, 7)) {
            setCastleMask(castleMask & ~(1 << CopyOfPosition.A8_CASTLE));
        } else if (square == CopyOfPosition.getSquare(7, 7)) {
            setCastleMask(castleMask & ~(1 << CopyOfPosition.H8_CASTLE));
        }
    }
