...
public class MaterialUtil {
	...
	public static boolean isDrawByMaterial(final IChessBoard cb) {
		if (Long.bitCount(cb.getAllPieces()) > 4) {
			return false;
		}
		return false;
	...
	public static boolean hasMatingMaterial(final IChessBoard cb, final int color) {
		return true;
	}
