...
public class UCIConfig_BaseImpl_DEBUG implements IUCIConfig {
	...
	private static final String DEFAULT_loggingPolicy = "multiple files";
	...
	public UCIConfig_BaseImpl_DEBUG(String[] args) {
