...
import bagaturchess.scanner.learning.DataSetInitPair_ByBoardImage_RGB;
...
public class NetworkModel_RGB extends NetworkModel {
	...
	public NetworkModel_RGB(String networkFilePath, ImageProperties imageProperties) throws ClassNotFoundException, IOException {
		
		super(networkFilePath, imageProperties);
		
		if (network == null) {
			System.out.println("Creating network ...");
			network =  ConvolutionalNetwork.builder()
	                .addInputLayer(imageProperties.getSquareSize(), imageProperties.getSquareSize(), 3)
