...
public class PatternsMatcherMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BufferedImage image_board = ImageHandlerSingleton.getInstance().loadImageFromFS("./data/tests/test13.png");
			//BufferedImage image_board = ImageHandlerSingleton.getInstance().loadImageFromFS("./data/tests/lichess.org/test1.png");
			//BufferedImage image_board = ImageHandlerSingleton.getInstance().loadImageFromFS("./data/tests/chess.com/test1.png");
