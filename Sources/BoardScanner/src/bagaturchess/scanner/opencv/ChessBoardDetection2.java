...
public class ChessBoardDetection2 {

	public static void main(String[] args) {
		
		System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
		
		new ChessBoardDetection2();
	}
	
	public ChessBoardDetection2() {
        ...
        Calib3d.drawChessboardCorners(source_rotated, new Size(7, 7), corners1, true);
