...
import bagaturchess.bitboard.impl1.attacks.FieldAttack;
import bagaturchess.bitboard.impl1.attacks.SEE;
import bagaturchess.bitboard.impl1.eval.BaseEvaluation;
import bagaturchess.bitboard.impl1.eval.MaterialFactor;
...
import bagaturchess.bitboard.impl2.movegen.BlackPawnMovesGen;
import bagaturchess.bitboard.impl2.movegen.CastleMovesGen;
import bagaturchess.bitboard.impl2.movegen.KingMovesGen;
import bagaturchess.bitboard.impl2.movegen.KnightMovesGen;
import bagaturchess.bitboard.impl2.movegen.MoveInt;
import bagaturchess.bitboard.impl2.movegen.OfficerMovesGen;
import bagaturchess.bitboard.impl2.movegen.QueenMovesGen;
...
public abstract class Board4 extends Fields implements IBoard, Cloneable {
	...
	public Board4(IBoardConfig boardConfig) {
		this(Constants.INITIAL_BOARD, boardConfig);
	}
	
	
	public Board4(String fenStr) {
		this(fenStr, (IBoardConfig)null);
	}
	
	
	public Board4(String fenStr, IBoardConfig boardConfig) {
		this(fenStr, null, boardConfig);
	}
	
	
	public Board4(String fenStr, PawnsEvalCache _pawnsCache, IBoardConfig _boardConfig) {
	...
	public void cloneInternal(Board4 clone) {
		//clone.free = free;
	...
	private boolean checkAliveFiguresData(Board4 other) {
