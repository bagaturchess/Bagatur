 ...
 *
 */
package bagaturchess.learning.goldmiddle.impl.cfg.bagatur_allfeatures;
...
public class Bagatur_ALL_LearningInputImpl implements ILearningInput {
	...
	public IBoardConfig createBoardConfig() {
		return new Bagatur_ALL_BoardConfigImpl();
	}
	
	
	public ISignalFiller createFiller(IBitBoard bitboard) {
		return new Bagatur_ALL_SignalFiller(bitboard);
	}
	
	
	public String getFeaturesConfigurationClassName() {
		return Bagatur_ALL_FeaturesConfigurationBagaturImpl.class.getName();
	}
}
