...
public interface FeatureWeights {
	...
	//Material
	public static final double MATERIAL_IMBALANCE_NIGHT_PAWNS_O			= 1;
	public static final double MATERIAL_IMBALANCE_NIGHT_PAWNS_E			= 1;
	...
	public static final double OTHERS_HANGING_O 						= 1;
	public static final double OTHERS_HANGING_E 						= 1;
	public static final double OTHERS_HANGING_2_O 						= 1;
	public static final double OTHERS_HANGING_2_E 						= 1;
