	...
	public static void main(String[] args) {
		...
		IRootSearchConfig cfg = new RootSearchConfig_BaseImpl_1Core(
			...
			new String[] {
						...
						bagaturchess.learning.goldmiddle.impl.cfg.base_allfeatures.filler.ALL_BoardConfig.class.getName(),
						//bagaturchess.learning.goldmiddle.run.cfg.EvaluationConfg.class.getName(),
						bagaturchess.learning.goldmiddle.impl.cfg.base_allfeatures.eval.EvaluationConfig.class.getName()
