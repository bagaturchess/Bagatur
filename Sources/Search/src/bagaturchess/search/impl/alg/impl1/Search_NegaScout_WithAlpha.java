...
public class Search_NegaScout_WithAlpha extends SearchImpl {
	...
	public Search_NegaScout_WithAlpha(Object[] args) {
		this(new SearchEnv((IBitBoard) args[0], getOrCreateSearchEnv(args)));
	}
	
	
	public Search_NegaScout_WithAlpha(SearchEnv _env) {
		super(_env);
