...
public class SearchMTD1 extends SearchAB1 {
	...
	public SearchMTD1(Object[] args) {
		super(args);
	}
	
	public SearchMTD1(SearchEnv _env) {
		super(_env);
	}
	
	public ISearchConfig1_MTD getSearchConfig() {
		return (ISearchConfig1_MTD) super.getSearchConfig();
	}
