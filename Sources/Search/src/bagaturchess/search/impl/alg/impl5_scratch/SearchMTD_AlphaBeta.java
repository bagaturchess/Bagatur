...
public class SearchMTD_AlphaBeta extends Search_AlphaBeta {
	
	protected static final boolean SEND_PV = true;
	
	private List<Integer> betas = new ArrayList<Integer>();
	
	public SearchMTD_AlphaBeta(Object[] args) {
		super(args);
	}
	
	public SearchMTD_AlphaBeta(SearchEnv _env) {
		super(_env);
	}
	...
	protected int getTrustWindow() {
		return 0;//getSearchConfig().getMTDTrustWindow();
	}
