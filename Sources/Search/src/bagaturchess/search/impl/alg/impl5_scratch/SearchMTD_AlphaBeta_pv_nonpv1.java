...
public class SearchMTD_AlphaBeta_pv_nonpv1 extends SearchImpl_MTD {
	...
	public SearchMTD_AlphaBeta_pv_nonpv1(Object[] args) {
		this(new SearchEnv((IBitBoard) args[0], getOrCreateSearchEnv(args)));
	}
	
	
	public SearchMTD_AlphaBeta_pv_nonpv1(SearchEnv _env) {
		super(_env);
	}
	...
	private int minmax_pv(ISearchMediator mediator, IRootWindow rootWin, ISearchInfo info, boolean inCheck, int initial_maxdepth, int maxdepth, int depth, int beta,
		...
		if (best_move == 0 || (best_eval < 0 && isMateVal(best_eval))) {
