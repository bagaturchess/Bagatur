...
public class BagaturEvaluator_Phases_OLD extends BaseEvaluator {
	...
	public BagaturEvaluator_Phases_OLD(IBitBoard _bitboard, IEvalCache _evalCache, IEvalConfig _evalConfig) {
	...
	protected BagaturEvaluator_Phases_OLD(IBitBoard _bitboard, IEvalCache _evalCache, IEvalConfig _evalConfig, IEvalComponentsProcessor _evalComponentsProcessor) {
