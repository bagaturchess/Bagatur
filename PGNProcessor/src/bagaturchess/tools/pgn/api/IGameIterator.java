...
public interface IGameIterator {
	public void preIteration(IBoard bitboard); // Called only once - at the begging of the run 
	public void postIteration(); // Called only once - at the end of the run 
	public void preGame(int gameCount, PGNGame pgnGame, String pgnGameID, IBoard bitboard); // Called before each new game
