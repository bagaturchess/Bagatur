...
public class NNUEProbeUtils {
	...
	*/
	public static final void fillInput(IBitBoard bitboard, Input input) {
		...
		//White king
		input.pieces[index] 	= convertPiece(ChessConstants.KING, ChessConstants.WHITE);
		input.squares[index] 	= getSquareID(bb_w_king);
		index++;
		
		//Black king
		input.pieces[index] 	= convertPiece(ChessConstants.KING, ChessConstants.BLACK);
		...
		//White queens
		while (bb_w_queens != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.QUEEN, ChessConstants.WHITE);
		...
		//Black queens
		while (bb_b_queens != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.QUEEN, ChessConstants.BLACK);
		...
		//White rooks
		while (bb_w_rooks != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.ROOK, ChessConstants.WHITE);
		...
		//Black rooks
		while (bb_b_rooks != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.ROOK, ChessConstants.BLACK);
		...
		while (bb_w_bishops != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.BISHOP, ChessConstants.WHITE);
		...
		while (bb_b_bishops != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.BISHOP, ChessConstants.BLACK);
		...
		while (bb_w_knights != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.NIGHT, ChessConstants.WHITE);
		...
		while (bb_b_knights != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.NIGHT, ChessConstants.BLACK);
		...
		//White pawns
		while (bb_w_pawns != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.PAWN, ChessConstants.WHITE);
		...
		//Black pawns
		while (bb_b_pawns != 0) {
			input.pieces[index] 	= convertPiece(ChessConstants.PAWN, ChessConstants.BLACK);
	...
	public static int convertPiece(int pieceType, int color) {
		switch(pieceType) {
			case Constants.TYPE_PAWN: return color == ChessConstants.WHITE ? 1 : 9;
			case Constants.TYPE_KNIGHT: return color == ChessConstants.WHITE ? 2 : 10;
			case Constants.TYPE_BISHOP: return color == ChessConstants.WHITE ? 3 : 11;
			case Constants.TYPE_ROOK: return color == ChessConstants.WHITE ? 4 : 12;
			case Constants.TYPE_QUEEN: return color == ChessConstants.WHITE ? 5 : 13;
			case Constants.TYPE_KING: return color == ChessConstants.WHITE ? 6 : 14;
