...
public class NNUEProbeUtils_V2 {
	...
	public static final void fillInput(IBitBoard bitboard, Input input) {
		...
		ChessBoard cb = (ChessBoard) bitboard;
		
		long bb_w_king 		= cb.getPieces(ChessConstants.WHITE, ChessConstants.KING);
		long bb_b_king 		= cb.getPieces(ChessConstants.BLACK, ChessConstants.KING);
		long bb_w_queens 	= cb.getPieces(ChessConstants.WHITE, ChessConstants.QUEEN);
		long bb_b_queens 	= cb.getPieces(ChessConstants.BLACK, ChessConstants.QUEEN);
		long bb_w_rooks 	= cb.getPieces(ChessConstants.WHITE, ChessConstants.ROOK);
		long bb_b_rooks 	= cb.getPieces(ChessConstants.BLACK, ChessConstants.ROOK);
		long bb_w_bishops 	= cb.getPieces(ChessConstants.WHITE, ChessConstants.BISHOP);
		long bb_b_bishops 	= cb.getPieces(ChessConstants.BLACK, ChessConstants.BISHOP);
		long bb_w_knights 	= cb.getPieces(ChessConstants.WHITE, ChessConstants.NIGHT);
		long bb_b_knights 	= cb.getPieces(ChessConstants.BLACK, ChessConstants.NIGHT);
		long bb_w_pawns 	= cb.getPieces(ChessConstants.WHITE, ChessConstants.PAWN);
		long bb_b_pawns 	= cb.getPieces(ChessConstants.BLACK, ChessConstants.PAWN);
