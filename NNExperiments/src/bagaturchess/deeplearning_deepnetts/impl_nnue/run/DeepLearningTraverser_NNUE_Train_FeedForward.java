...
import bagaturchess.deeplearning_deepnetts.impl_nnue.visitors.DeepLearningVisitorImpl_NNUE_Train_FeedForward;
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				PositionsVisitor success_rate_printer = new DeepLearningVisitorImpl_PrintSuccessRate_FeedForward(ActivationFunction.SIGMOID);
