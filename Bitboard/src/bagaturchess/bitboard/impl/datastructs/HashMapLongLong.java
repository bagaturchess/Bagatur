...
public class HashMapLongLong {
   ...
   */
  public HashMapLongLong(int initialCapacity, int growStep, float loadFactor) {
   ...
   */
  public Object clone() {
    HashMapLongLong result = null;
		try {
			result = (HashMapLongLong) super.clone();
