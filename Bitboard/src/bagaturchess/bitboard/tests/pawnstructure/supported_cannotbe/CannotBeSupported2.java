...
public class CannotBeSupported2 extends PawnStructureTest {
	...
	public void validate() {
		...
		validateHalfOpenedFiles(Figures.COLOUR_WHITE, LETTER_C | LETTER_D | LETTER_E | LETTER_F);
		validateHalfOpenedFiles(Figures.COLOUR_BLACK, LETTER_A | LETTER_B | LETTER_G | LETTER_H);
